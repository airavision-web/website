        ...
        <div className="max-w-container-max mx-auto space-y-24">
          ...
          <div className="pt-4">
            <div className="flex items-center mb-stack-lg">
              <h2 className="font-headline-lg text-headline-lg text-primary mr-4">Core Certifications</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-blueprint-blue">
                <div className="w-12 h-12 bg-primary/10 text-primary rounded flex items-center justify-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>
                </div>
                <h3 className="font-headline-md text-headline-md text-primary mb-2">ISO 9001:2015</h3>
                <p className="font-body-md text-body-md text-on-surface-variant mb-4">Quality Management System</p>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-construction-orange">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">ISO 14001:2015</h3>
                <p className="font-body-md text-body-md text-on-surface-variant mb-4">Environmental Management</p>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-secondary">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">ISO 45001:2018</h3>
                <p className="font-body-md text-body-md text-on-surface-variant mb-4">Occupational Health & Safety</p>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-blueprint-blue">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">PMP Certified</h3>
                <p className="font-body-md text-body-md text-on-surface-variant mb-4">Project Management Professionals</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-gutter">
                <div className="bg-primary text-on-primary p-6 rounded-sm border-t-4 border-construction-orange shadow-sm">
                  ...
                  <p className="font-body-md text-sm text-on-primary/80">Consistent track record of meeting critical path deadlines.</p>
                </div>
                <div className="bg-surface-container-lowest border border-surface-container-highest p-6 rounded-sm border-t-4 border-blueprint-blue shadow-sm">
                  <div className="font-display-lg text-display-lg text-primary mb-2">10+</div>
                  <div className="font-headline-md text-headline-md text-primary mb-2 text-lg">Years LTI Free</div>
                  <p className="font-body-md text-sm text-on-surface-variant">Uncompromising commitment to zero Lost Time Incidents.</p>
                </div>
              </div>
            </div>
          </div>
