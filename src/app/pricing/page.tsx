        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
            {
              ...
              >
                <h3 className={`text-2xl font-bold mb-2 ${plan.featured ? "" : "text-blue-900"}`}>
                  {plan.name}
                </h3>
                <p className={`mb-4 ${plan.featured ? "text-blue-100" : "text-blue-900"}`}>
                  {plan.description}
                </p>
                <div className="mb-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-semibold text-blue-900 mb-4">Additional Services</h3>
              <ul className="space-y-3 text-blue-900">
