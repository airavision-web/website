        ...
        <div className="max-w-container-max mx-auto space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            <div className="md:col-span-6">
              <div className="flex items-center gap-4 mb-stack-sm">
                ...
                <h2 className="font-headline-lg-mobile text-headline-lg-mobile md:font-headline-lg md:text-headline-lg text-primary">Crafting Exceptional Environments</h2>
              </div>
          ...
          <div className="border-t border-surface-variant pt-16">
            <div className="text-center mb-12">
              <h2 className="font-headline-lg-mobile text-headline-lg-mobile md:font-headline-lg md:text-headline-lg text-primary mb-2">Interior Design Solutions We Offer</h2>
              <p className="font-body-md text-body-md text-on-surface-variant">Comprehensive design expertise across all structural domains.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-blueprint-blue">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">Residential</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">Bespoke home interiors that reflect your lifestyle, ensuring comfort and elegance in every room.</p>
              </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-construction-orange">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">Commercial</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">High-performance workspaces designed to enhance productivity and impress enterprise clients.</p>
              </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-sm shadow-sm border border-surface-container-highest hover:shadow-[0_4px_20px_rgba(0,43,91,0.08)] transition-shadow duration-300 border-t-4 border-t-secondary">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2">Modular Kitchens</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">Ergonomically engineered culinary spaces maximizing storage efficiency and modern aesthetics.</p>
              </div>
            </div>
          </div>
