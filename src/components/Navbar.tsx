    ...
    <nav className="w-full top-0 sticky bg-white border-b border-steel-gray/20 z-50">
      <div className="flex justify-between items-center max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/about" className="text-on-surface-variant py-1 text-base font-medium transition-colors duration-200 ease-in-out hover:text-construction-orange">
            About Us
          </Link>
          
          {/* Services Dropdown */}
          <div className="relative group py-1">
            <button className="text-on-surface-variant text-base font-medium transition-colors duration-200 flex items-center gap-1 group-hover:text-construction-orange">
            ...
            <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-steel-gray/20 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <Link href="/services/project-management" className="block px-4 py-2 text-base font-medium text-slate-800 hover:bg-slate-50 hover:text-construction-orange transition-colors">
                Project Management Consultancy
              </Link>
              <Link href="/services/home-inspection" className="block px-4 py-2 text-base font-medium text-slate-800 hover:bg-slate-50 hover:text-construction-orange transition-colors border-t border-steel-gray/10">
                Flat Evaluation
              </Link>
              <Link href="/services/interior-designing" className="block px-4 py-2 text-base font-medium text-slate-800 hover:bg-slate-50 hover:text-construction-orange transition-colors border-t border-steel-gray/10">
                Interior Designing
              </Link>
            </div>
          </div>

          <Link href="/projects" className="text-on-surface-variant py-1 text-base font-medium transition-colors duration-200 ease-in-out hover:text-construction-orange">
            Projects
          </Link>
          <Link href="/gallery" className="text-on-surface-variant py-1 text-base font-medium transition-colors duration-200 ease-in-out hover:text-construction-orange">
            Gallery
          </Link>
          <Link href="/certifications" className="text-on-surface-variant py-1 text-base font-medium transition-colors duration-200 ease-in-out hover:text-construction-orange">
            Certifications
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-steel-gray/20 absolute w-full left-0 top-full shadow-lg h-[calc(100vh-73px)] overflow-y-auto">
          <div className="flex flex-col px-6 py-4 space-y-4 pb-8">
            ...
            <Link href="/services/home-inspection" className="text-slate-900 py-2 text-lg font-bold border-b border-gray-100" onClick={() => setIsOpen(false)}>Flat Evaluation</Link>
            ...
            <Link href="/certifications" className="text-slate-900 py-2 text-lg font-bold border-b border-gray-100" onClick={() => setIsOpen(false)}>Certifications</Link>
